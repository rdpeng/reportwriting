...
```{r,echo=FALSE}
knitr::opts_chunk$set(comment = NA, fig.path = "images/")
```
...
```{r,fig.cap="Comparison of 'capitalAve' between spam and non-spam emails"}
...
```{r,fig.cap="Log transformed 'captialAve'"}
...
```{r,fig.cap="Paris plot of 4 variables"}
...
```{r,fig.cap="Hierarichal cluster analysis"}
...
```{r,fig.cap="Hierarchical cluster analysis of log-transformed data"}
